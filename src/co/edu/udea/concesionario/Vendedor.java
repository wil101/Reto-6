...
public class Vendedor {
    ...
    public Vendedor(String nombre, String apellido, String descripcion, 
            int numeroDeDocumento, int edad, int totalVendido, int anioDeIngreso) throws numeroInvalido {
        this.nombre = nombre;
        ...
        if(anioDeIngreso > 2022) throw new numeroInvalido();
        else this.anioDeIngreso = anioDeIngreso;
    }

    public void setEdad(int edad) throws numeroInvalido{
        if(edad >= 0){
            this.edad = edad;
        }else {
